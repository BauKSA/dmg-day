...
void InventoryScene_DrawCoins()
{
    ...
    set_bkg_tiles(INVENTORY_COIN_STARTS_X, INVENTORY_COIN_STARTS_Y, 1, 1, &thousands);
    set_bkg_tiles(INVENTORY_COIN_STARTS_X + 1, INVENTORY_COIN_STARTS_Y, 1, 1, &hundreds);
    set_bkg_tiles(INVENTORY_COIN_STARTS_X + 2, INVENTORY_COIN_STARTS_Y, 1, 1, &tens);
    set_bkg_tiles(INVENTORY_COIN_STARTS_X + 3, INVENTORY_COIN_STARTS_Y, 1, 1, &units);
}
